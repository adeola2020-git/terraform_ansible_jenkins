output "pub1a_instance_ip" {
  value = aws_instance.pub1a.public_ip #aws_instance.pub1.0.public_ip
}

output "pub1b_instance_ip" {
  value = aws_instance.pub1b.public_ip #aws_instance.pub1.0.public_ip
}

output "pub1c_instance_ip" {
  value = aws_instance.pub1c.public_ip #aws_instance.pub1.0.public_ip
}
...
# output "priv1_instance_ip" {
#   value = aws_instance.priv1.private_ip
# }

# output "priv2_instance_ip" {
